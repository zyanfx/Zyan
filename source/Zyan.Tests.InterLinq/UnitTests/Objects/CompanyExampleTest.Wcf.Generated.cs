...
namespace InterLinq.UnitTests.Objects
{
	...
	public class CompanyExampleTestWcf
	{
		#region Fields
		...
		/// </summary>
		protected CompanyContext companyExampleContext = new CompanyContext(ClientEnvironment.GetInstanceWcf(ServiceConstants.ObjectsServiceName).QueryHandler);
