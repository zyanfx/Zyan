...
namespace InterLinq.UnitTests.Objects
{
	...
	[TestClass]
	public class CompanyExampleTestZyan
	{
		#region Fields
		...
		/// </summary>
		protected CompanyContext companyExampleContext = new CompanyContext(ClientEnvironment.GetInstanceZyan(ServiceConstants.ObjectsServiceName).QueryHandler);
