...
{
    /// <summary>
    /// Verbindung zu einem Cyan Applikatonsserver oder einer benutzerdefinierten Cyan-Serveranwendung.
    /// </summary>
    public class CyanConnection : IDisposable
    {
        ...
        public CyanConnection(string serverUrl)
        ...
        public CyanConnection(string serverUrl, IClientProtocolSetup protocolSetup)
        ...
        public CyanConnection(string serverUrl, IClientProtocolSetup protocolSetup, Hashtable credentials)
        {
        ...
        public T CreateProxy<T>(bool implicitTransactionTransfer)
        {
            ...
            // Proxy erzeugen
            CyanProxy proxy = new CyanProxy(typeof(T), factory,implicitTransactionTransfer,_sessionID);
