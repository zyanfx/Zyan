...
namespace Cyan.Communication
{
    ...
    {
        // Felder
        private CyanComponentHost _host = null;

        /// <summary>
        /// Konstruktor.
        /// </summary>
        /// <param name="host">Komponentenhost</param>
        public ComponentInvoker(CyanComponentHost host)
        {
        ...
        public object Invoke(string interfaceName, ArrayList outputPinCorrelationSet, string methodName, params object[] args)
        {
            ...
            LogicalCallContextData data=CallContext.GetData("__CyanContextData") as LogicalCallContextData;
