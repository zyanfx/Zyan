...
namespace Zyan.Communication.ChannelSinks.Counter
{
	...
	{	
		...
		public CounterRemotingException(string message) : base(message)
		{
		}
		...
		public CounterRemotingException(string message, Exception innerException) : base(message, innerException)
		{
		}
		...
		protected CounterRemotingException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
