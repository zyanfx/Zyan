...
namespace InterLinq.UnitTests.Objects
{
	...
	/// </summary>
	[TestClass]
	public class CompanyExampleTestRemoting
	{
		#region Fields
		...
		/// </summary>
		protected CompanyContext companyExampleContext = new CompanyContext(ClientEnvironment.GetInstanceRemoting(ServiceConstants.ObjectsServiceName).QueryHandler);
