/*
// EmitHelper.cs is a part of Business Logic Toolkit for .NET
// www.bltoolkit.net
//
...
namespace GenericWrappers
{
	...
	public class EmitHelper
	{
		...
		/// <summary>
		/// Gets or sets flag indicating that the current method is static
		/// </summary>
		...
		private static Exception CreateNoSuchMethodException(Type type, string methodName)
		{
			return new InvalidOperationException(
				string.Format("No such method: {1}, type {0}", type.FullName, methodName));
		}

		private static Exception CreateNotExpectedTypeException(Type type)
		{
			return new ArgumentException(
				string.Format("Not expected type: {0}", type.FullName));
		}
	}
}
