...
namespace Zyan.Communication.ChannelSinks.Counter
{
    ...
    internal class CounterClientChannelSink : BaseChannelSinkWithProperties, IClientChannelSink
    {
		...
		/// <param name="requestStream">Antwort-Datenstrom (unverschlüsselt nach Verarbeitung!)</param>
        ...
        private void DoProcessMessageBefore(IMessage msg, ITransportHeaders requestHeaders, Stream requestStream)
        {
            ...
            Console.WriteLine(String.Format("Request: - ClientCounterBefore - Methode - {0} - {1} Bytes", myIDictionary != null ? myIDictionary["__MethodName"] : "Unknown", length));
        ...
        private void DoProcessMessageAfter(IMessage msg, ITransportHeaders responseHeaders, Stream responseStream)
        {
            ...
            Console.WriteLine(String.Format("Response: - ClientCounterAfter - Methode - {0} - {1} Bytes", myIDictionary != null ? myIDictionary["__MethodName"] : "Unknown", length));
		...
		/// <param name="responseHeaders">Anfrage-Header-Auflistung</param>
